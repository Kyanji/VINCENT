...
class Standard_Distiller(keras.Model):
    ...
    def train_step(self, data):
        ...
        with tf.GradientTape() as tape:
            ...
            student_predictions = self.student(img, training=True)
    ...
    def test_step(self, data):
        ...
        heatmap = x_pre[1]
        # Compute predictions
        y_prediction = self.student(img, training=False)
        # TODO soft
        # Calculate the loss
    ...
    def call(self, data):
        ...
        img = x_pre[0]
        heatmap = x_pre[1]
        return self.student(img, training=False)
# TODO
